...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="navbar">
      ...
      <div
        className={
          "absolute bg-white w-full left-0 top-full mt-0.5 " +
      ...
      >
        ...
        <i className="fi fi-bs-search absolute right-[10%] md:pointer-events-none md:left-5 top-1/2 -translate-y-1/2 text-xl text-dark-blue"></i>
      </div>
